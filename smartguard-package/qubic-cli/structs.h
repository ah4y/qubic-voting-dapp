...
enum COMMAND
{
    ...
    CONTRACT_COMPILE = 117,
    CONTRACT_VALIDATE = 118,
    CONTRACT_DEPLOY = 119,
    CONTRACT_CALL = 120,
    FAUCET_REQUEST = 121,
    WALLET_BALANCE = 122,
    // Real Qubic Dev Kit Execution Commands
    REAL_CONTRACT_DEPLOY = 123,
    REAL_CONTRACT_CALL = 124,
    REAL_VOTING_CREATE = 125,
    REAL_VOTING_CAST = 126,
    REAL_VOTING_RESULTS = 127,
    REAL_BALANCE = 128,
    REAL_TRANSFER = 129,
