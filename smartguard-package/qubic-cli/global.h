...
// Contract compile variables
char g_contract_source_file[256];
char g_contract_output_file[256];
char g_contract_bytecode_file[256];

// Contract deployment variables
char g_deploy_bytecode_file[256];
char* g_deploy_wallet_name = nullptr;
char* g_deploy_network = nullptr;
uint64_t g_deploy_gas_limit = 0;
uint64_t g_deploy_gas_price = 0;

// Contract call variables
char* g_call_contract_address = nullptr;
char* g_call_function_name = nullptr;
char* g_call_wallet_name = nullptr;
char* g_call_network = nullptr;
char* g_call_function_args = nullptr;
